...
public class MediaFileController {
    ...
    @PostMapping(value = "/tb-ui/authoring/rest/mediafilesnew", consumes = {"multipart/form-data"})
    public ResponseEntity<?> postMediaFileNew(Principal p,
                                            @RequestParam("mediaFileDataName") String mediaFileDataName,
                                            @RequestParam("mediaFileDataDirectoryId") String mediaFileDataDirectoryId,
                                           Locale locale,
                                           @RequestPart(name = "uploadFile", required = false) MultipartFile uploadedFile)
            throws IOException {

        MediaFile mediaFileData = new MediaFile();
        mediaFileData.setName(mediaFileDataName);
        mediaFileData.setDirectory(mediaDirectoryDao.findByIdOrNull(mediaFileDataDirectoryId));
